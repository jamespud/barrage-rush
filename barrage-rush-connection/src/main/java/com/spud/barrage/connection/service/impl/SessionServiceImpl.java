...
public class SessionServiceImpl implements SessionService {
    ...
    @Override
    public UserSession createSession(Long userId, Long roomId, String nickname, String avatar, String ip, String location) {
        ...
        redisTemplate.opsForValue().set(key, session, properties.getRedis().getUserSessionExpire(), TimeUnit.SECONDS);
        
        // 增加房间在线人数
        incrementRoomOnlineCount(roomId);
        
        log.info("创建用户会话: sessionId={}, userId={}, roomId={}, nickname={}", sessionId, userId, roomId, nickname);
        return session;
    }
    ...
    public boolean deleteSession(String sessionId) {
        ...
        if (session != null) {
            ...
            log.info("删除用户会话: sessionId={}, userId={}, roomId={}", sessionId, session.getUserId(), session.getRoomId());
            return true;
        }
        return false;
    }
