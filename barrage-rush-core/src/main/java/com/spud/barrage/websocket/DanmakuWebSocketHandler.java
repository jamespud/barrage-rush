...
import com.spud.barrage.model.dto.WebSocketRequest;
...
public class DanmakuWebSocketHandler extends TextWebSocketHandler {
  ...
  private void sendRecentMessages(WebSocketSession session, String roomId) {
    try {
      List<DanmakuMessage> recentDanmaku = danmakuService.getRecentDanmaku(roomId, 50);
